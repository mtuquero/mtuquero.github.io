...
- User goes to the landing page, logs in, searches for a specific fish (e.g., Ahi), and views where and when others caught it.  

## Beyond the basics
---
After implementing the basic functionality, here are ideas for more advanced features:

- Add AI features that analyze fishing data to suggest good times or areas to fish.  
- Show weather or tide information for fishing areas.  
- Let users upload photos of their catches.  
- Add a comment section for users to share tips or feedback.  
- Allow users to mark favorite fishing spots.  
